...
:class: formule
**L'incertitude absolue** d'une mesure $A$, notée $\Delta A$ ("delta A"), donne une information sur la précision du résultat de la mesure. La mesure sera alors notée comme :
:::{math}
A\pm\Delta A
:::
::::
